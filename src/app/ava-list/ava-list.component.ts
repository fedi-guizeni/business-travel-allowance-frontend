...
@Component({
  selector: 'app-ava-list',
  templateUrl: './ava-list.component.html',
  styleUrls: ['./ava-list.component.css']
})
export class AvaListComponent implements OnInit {
  ...
  public getAvas(showNotification: boolean):void{
    this.refreshing = true;
      ...
      this.subscriptions.push(
        this.avaService.getavasAmendement().subscribe({
          next:
  ...
  public onUpdateAva():void{
    if( this.editAva.avaType===AvaType.AUTREACTIVITE){
      this.editAva.statutValidationDossier=null
