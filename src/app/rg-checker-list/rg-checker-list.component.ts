...
@Component({
  selector: 'app-rg-checker-list',
  templateUrl: './rg-checker-list.component.html',
  styleUrls: ['./rg-checker-list.component.css']
})
export class RgCheckerListComponent implements OnInit {
  ...
  public getAvas(showNotification: boolean):void{
    this.refreshing = true;
      ...
      this.subscriptions.push(
        this.avaService.getavasforRgChecker().subscribe({
          next:
  ...
  public onUpdateAva():void{
    if( this.editAva.avaType===AvaType.AUTREACTIVITE){
      this.editAva.statutValidationDossier="Valide" 
      this.editAva.statutDossier="Active"
